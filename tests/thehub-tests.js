...
test('subscriber', function() {
    ...
    var subscriber1 = new util.Hub.Subscriber(fun, context);
    var subscriber2 = new util.Hub.Subscriber(fun, context);
    var subscriber3 = new util.Hub.Subscriber(function() {});

    ok(subscriber1 === subscriber2, 'equals');
    ok(subscriber2 === subscriber1, 'equals');
    ok(subscriber1 !== subscriber3, 'equals');
